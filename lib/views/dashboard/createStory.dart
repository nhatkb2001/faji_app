...
class atCreateStoryScreen extends StatefulWidget {
  String uid;

  atCreateStoryScreen(required, {Key? key, required this.uid})
      : super(key: key);

  @override
  _atCreateStoryScreen createState() => _atCreateStoryScreen(uid);
}

class _atCreateStoryScreen extends State<atCreateStoryScreen>
    with SingleTickerProviderStateMixin {
  String uid = '';
  _atCreateStoryScreen(uid);
  File? imageFile;
  File? videoFile;
  String link = '';
